...
namespace BasicThirteen
{
    class Program
    {
        ...
        public static void MinMaxAverage(int[] numbers)
        {
            ...
            Console.WriteLine($"The maximum value is {max}, the minimum value is {min}, and the average is {avg}.");
        }
        ...
        public static object[] NumToString(int[] numbers)
        {
            ...
            object[] numObject = new object[numbers.Length];
            for (int i = 0; i < numbers.Length; i++)
            {
                if (numbers[i] < 0)
                {
                    ...
                    numObject[i] = numbers[i];
                }
                Console.WriteLine(numObject[i]);
            }
            return numObject;
        }
        ...
        static void Main(string[] args)
        {
            ...
            PrintOdds();
            PrintSum();
            LoopArray(new int[] {2, 10, 3});
            Console.WriteLine(FindMax(new int[] {-5, -3, 10, -1}));
